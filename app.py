...
with st.sidebar:
    ...
    PREVIEW_MAX_W = st.slider("Image preview max width (px)", 280, 1000, 1000, 10)
    PREVIEW_MAX_H = st.slider("Image preview max height (px)", 200, 900, 350, 10)
...
if file:
    ...
    r1_left, r1_right = st.columns([2,1])#, gap="large")
    with r1_left:
